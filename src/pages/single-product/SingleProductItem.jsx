...
const SingleProductItem = ({ obj, addProductToShopCart }) => {
  ...
  return (
    <div className="single-product">
        ...
        <div className="single-product_info">
            ...
            <button className={`single-product_info_btn ${!obj.available && 'out-of-service'}`} 
              onClick={()=>{
                 obj.available && addProductToShopCart(obj)
                 showAlart()
              }}>
                افزودن به سبد خرید
                <ToastContainer
